...
public class Solution {
    ...
    public static boolean isWeekend(LocalDateTime dateTime) {
        boolean flag = false;
        if ((dateTime.getDayOfWeek() == DayOfWeek.FRIDAY) & !(dateTime.toLocalTime().isBefore(LocalTime.of(22,00,00)))) {
            flag = true;
        } else if ((dateTime.getDayOfWeek() == DayOfWeek.SUNDAY) & (dateTime.toLocalTime().isBefore(LocalTime.of(23,00,00)))) {
            flag = true;
